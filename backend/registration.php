					...
					<div class="tab-pane active" id="horizontal-form">
						<form class="form-horizontal" action="" method="post" name="reg" onsubmit="return validate(this)">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" onkeydown="return onlyNumbers(event);"  title="Only Number" class="form-control1 input-sm" name="mo"  id="smallinput" placeholder="Mobile no" required=""/>
								</div>
							</div>
							<div class="form-group">
